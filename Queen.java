...
public class Queen extends PieceAbstract {
	...
	public Queen (Board board, Colour colour, int row, int col) {
		super(board,colour,row,col);
		possibleMoves = new int[27][2];
	}
	
	public Queen (Board board, Colour colour, int row, int col, PieceAbstract next) {
	...
	public boolean move(int r, int c) {
		...
		int absRow = Math.abs(diffRow);
		int absCol = Math.abs(diffCol);
